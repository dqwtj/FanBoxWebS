...
b1 = Box.create(name: "吴亦凡")
b2 = Box.create(name: "越苏")
b3 = Box.create(name: "古剑奇谭")
b4 = Box.create(name: "EXO")
b5 = Box.create(name: "美国队长")
b6 = Box.create(name: "盾铁")
b7 = Box.create(name: "李易峰")
b8 = Box.create(name: "心心念念李苏苏")
b9 = Box.create(name: "陈伟霆我好中意你")
b10 = Box.create(name: "二胡卵子")
b11 = Box.create(name: "瓶邪")
b12 = Box.create(name: "全是猫")
b13 = Box.create(name: "哈利波特")

t1 = Tag.create(card: c1, box: b10, hit_count: 124)
t2 = Tag.create(card: c1, box: b11, hit_count: 100)
t3 = Tag.create(card: c2, box: b5, hit_count: 111)
t4 = Tag.create(card: c2, box: b6, hit_count: 23)
t5 = Tag.create(card: c2, box: b12, hit_count: 543)
t6 = Tag.create(card: c3, box: b7, hit_count: 234)
t7 = Tag.create(card: c3, box: b3, hit_count: 124)
t8 = Tag.create(card: c3, box: b9, hit_count: 100)
t9 = Tag.create(card: c3, box: b2, hit_count: 234)
t10 = Tag.create(card: c4, box: b2, hit_count: 432)
t11 = Tag.create(card: c4, box: b3, hit_count: 24)
t12 = Tag.create(card: c5, box: b2, hit_count: 65)
t13 = Tag.create(card: c5, box: b3, hit_count: 754)
t14 = Tag.create(card: c5, box: b8, hit_count: 123)
t15 = Tag.create(card: c5, box: b9, hit_count: 89)
t16 = Tag.create(card: c6, box: b5, hit_count: 176)
t17 = Tag.create(card: c6, box: b13, hit_count: 231)
t18 = Tag.create(card: c7, box: b1, hit_count: 79)
t19 = Tag.create(card: c8, box: b10, hit_count: 231)
t20 = Tag.create(card: c8, box: b5, hit_count: 124)
